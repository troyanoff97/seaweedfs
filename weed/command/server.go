...
func init() {
	...
	serverOptions.v.diskPlacement = cmdServer.Flag.String("volume.diskPlacement", "leastLoad", "how to pick -dir for new volumes: leastLoad or roundRobin")
	...
	s3Options.maxConnections = cmdServer.Flag.Int("s3.maxConnections", 0, "max accepted TCP connections for S3 HTTP; 0=auto when any concurrent upload limit>0 (fileLimit*32 or 1024, min 1024), -1=unlimited")
